  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center bg-[var(--moiz-bg)] text-[var(--moiz-text)] px-4 text-center">
      <div className="relative mb-8">
        <Cat
          className="w-32 h-32 text-[var(--moiz-green)] opacity-20 mx-auto"
          strokeWidth={1}
        />
      ...
      <p className="text-lg text-gray-600 mb-8 max-w-md">
        La página que estás buscando no existe, ha sido movida o está jugando a
        las escondidas en otra caja de arena.
      </p>
