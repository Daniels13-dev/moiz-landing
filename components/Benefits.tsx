...
export default function Benefits() {
  ...
  const benefits = [
    { id: 0, Icon: Leaf, title: "100% Natural", desc: "Hecho a base de maíz seleccionado, libre de químicos y fragancias artificiales.", color: "var(--moiz-green)", bg: "bg-[var(--moiz-green)]/10" },
    { id: 1, Icon: Recycle, title: "Biodegradable", desc: "Se desecha por el sanitario o se usa como abono para plantas.", color: "var(--moiz-yellow)", bg: "bg-white/60" },
    { id: 2, Icon: ShieldCheck, title: "Seguro para michis", desc: "Suave con sus patas y libre de agentes irritantes para michis sensibles.", color: "var(--moiz-pink)", bg: "bg-[#FFEAF3]" },
    { id: 3, Icon: Droplets, title: "Control de olores", desc: "Neutralización orgánica que mantiene tu hogar fresco siempre.", color: "#3b82f6", bg: "bg-blue-50" },
    { id: 4, Icon: Wind, title: "99.9% Sin Polvo", desc: "Cuida el sistema respiratorio de tu gato y mantiene tu casa impecable.", color: "#14b8a6", bg: "bg-white" },
  ];
  ...
  const getIconMotion = (id: number) => {
    ...
    switch (id) {
      case 0: return { rotate: [0, -10, 10, -10, 0] };
      case 1: return { rotate: 360 };
      case 2: return { scale: [1, 1.2, 1] };
      case 3: return { y: [0, -5, 0] };
      case 4: return { x: [-3, 3, -3] };
      default: return {};
    }
  };
  ...
  return (
    <section id="beneficios" className="py-24 bg-zinc-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <span className="text-[var(--moiz-green)] font-semibold tracking-wider text-sm uppercase mb-3 block">Por qué elegir Möiz</span>
          ...
          <p className="text-lg text-zinc-500 max-w-2xl mx-auto mt-4">
            Nuestra arena está pensada tanto para el bienestar de tu gato, como para la comodidad de tu hogar y el cuidado del planeta.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <p className="text-zinc-600 font-medium">{benefits[1].desc} Aporta a un ciclo completamente sostenible.</p>
          </motion.article>
          ...
          >
            ...
            <h3 className="font-extrabold text-2xl text-zinc-900 mb-4 relative z-10">{benefits[4].title}</h3>
