...
export default function Hero() {
  return (
  <section id="hero" className="relative min-h-[95vh] flex flex-col items-center justify-center overflow-hidden bg-white pt-24 pb-20">
      ...
      <div className="relative z-10 w-full text-center px-4">
        ...
        >
          Instinto <br /> 
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--moiz-green)] via-[#86A93C] to-[#E6B800]">Natural.</span>
        </motion.h1>
      </div>
      ...
      >
        <p className="text-lg md:text-2xl font-medium text-zinc-600 max-w-2xl leading-relaxed">
          Arena para gatos 100% compostable. Cero polvo, aglomeración extrema y el control de olores más limpio del mercado.
        </p>
        
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
          <a
            href="/productos"
            className="group relative inline-flex items-center justify-center px-10 py-5 bg-[var(--moiz-green)] text-white rounded-full font-bold text-lg overflow-hidden shadow-[0_10px_40px_rgba(106,142,42,0.4)] hover:shadow-[0_15px_50px_rgba(106,142,42,0.6)] transition-all duration-300 hover:-translate-y-1"
          >
          ...
          <a href="#beneficios" className="inline-flex items-center justify-center px-8 py-5 text-zinc-600 font-bold text-lg hover:text-[var(--moiz-green)] transition-colors">
            Descubrir más
          </a>
        </div>
      </motion.div>
      ...
      >
        <div className="w-12 h-12 bg-[#F1ECD4] text-[var(--moiz-yellow)] rounded-2xl flex items-center justify-center text-2xl">🌱</div>
        <div className="flex flex-col">
          <span className="font-extrabold text-zinc-900 text-base">Ecológica</span>
          <span className="text-sm text-zinc-500 font-medium">Hecha de maíz</span>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="flex flex-col">
          <span className="font-extrabold text-zinc-900 text-base">99.9% Sin Polvo</span>
          <span className="text-sm text-zinc-500 font-medium">Respiración pura</span>
        </div>
      </motion.div>
      ...
      >
        <div className="w-12 h-12 bg-zinc-100 text-zinc-900 rounded-2xl flex items-center justify-center text-2xl">🧱</div>
        <div className="flex flex-col">
          <span className="font-extrabold text-zinc-900 text-base">Aglomeración</span>
          <span className="text-sm text-zinc-500 font-medium">Fácil limpieza</span>
        </div>
      </motion.div>
      ...
      >
        <div className="flex -space-x-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="w-12 h-12 rounded-full bg-zinc-100 border-2 border-white overflow-hidden shadow-sm flex items-center justify-center">
               <Image src={`/logo/logo.png`} alt={`Cat`} width={32} height={32} className="object-cover opacity-60" />
            </div>
          ))}
        </div>
        <div className="flex flex-col">
          <span className="font-extrabold text-zinc-900 text-base">4.9/5 Estrellas</span>
          <span className="text-sm text-zinc-500 font-medium">+1,200 Michis Felices</span>
        </div>
      </motion.div>
